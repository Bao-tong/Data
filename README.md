...
| **Appendix D** | Detailed computational results                       | Supports result verification and model reproduction                   |
...
Appendix D contains the complete numerical outputs generated by the economic evaluation, simulation, and optimization models.

The tables are organized into nine functional groups:

* **Main results dashboard — Tables D1–D2**
...
* **Interactive calculations — Table D4**
...
* **Unitree G1 thresholds — Table D5**
...
* **Hybrid workforce optimization — Tables D11–D12**
